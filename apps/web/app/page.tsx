...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden font-sans">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <motion.div
            ...
            className="relative rounded-3xl border border-brand/20 bg-gradient-to-br from-brand/5 via-violet-500/5 to-indigo-500/5 p-12 md:p-16 backdrop-blur shadow-2xl"
          >
            {/* Corner Decorative Lights */}
            <div className="absolute top-0 left-0 w-24 h-24 bg-gradient-to-br from-brand/20 to-transparent blur-xl rounded-tl-3xl pointer-events-none" />
            <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-tl from-indigo-500/20 to-transparent blur-xl rounded-br-3xl pointer-events-none" />
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
              <Link
                href="/auth"
                className="group flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-primary px-8 py-4 text-base font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary/95 hover:shadow-primary/35 hover:-translate-y-0.5 active:translate-y-0"
              >
                Connect Wallet
              ...
              <Link
                href="/auth"
                className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl border border-border bg-card/50 px-8 py-4 text-base font-semibold text-foreground transition-all hover:bg-muted hover:border-muted-foreground/30"
              >
                Launch Platform
              </Link>
            </div>
      ...
      <footer className="border-t border-border/60 bg-muted/10 dark:bg-muted/5 py-12 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <a href="#tech-stack" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
                    Tech Stack
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5">
                    <Github className="h-3.5 w-3.5" /> GitHub
                  </a>
                </li>
                <li>
                  <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1.5">
